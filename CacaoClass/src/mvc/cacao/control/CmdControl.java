...
import mvc.cacao.cmd.CmdCacaoMain;
import mvc.cacao.cmd.CmdException;
import mvc.cacao.cmd.CmdInput;
import mvc.cacao.cmd.CmdList;
import mvc.cacao.cmd.CmdNull;

/**
 * Servlet implementation class GuestControl
 */
public class CmdControl extends HttpServlet {
	...
	private void initCommand(){
		...
		commandMap.put("main-page",	new CmdNull("main.jsp") );
