...
public class Board
{
	...
	public Board( int articleId,  int groupId, String sequenceNo, String postingDate, int readCount, String writerName, String password, String title,  String content )
	{
