...
<body>
	...
	<a href="listMessage.jsp?pageno=1"><input type="button" value="<<"/></a>
<a href="listMessage.jsp?pageno=<%=prev_pageno%>"><input type="button" value="<"/></a> 
<%for(int i =page_sno;i<=page_eno;i++){%>
	<a href="listMessage.jsp?pageno=<%=i %>">
...
<a href="listMessage.jsp?pageno=<%=next_pageno%>" ><input type="button" value=">"/></a>
<a href="listMessage.jsp?pageno=<%=total_page %>"><input type="button" value=">>"/></a>
