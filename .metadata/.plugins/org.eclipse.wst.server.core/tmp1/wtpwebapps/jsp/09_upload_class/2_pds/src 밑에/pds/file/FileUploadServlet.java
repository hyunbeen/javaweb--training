...
public class FileUploadServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp)
		...
		if (contentType != null
			...
			RequestDispatcher dispatcher = req
					.getRequestDispatcher("/09_upload/2_pds/uploaded.jsp");
			dispatcher.forward(req, resp);
		} else {
			RequestDispatcher dispatcher = req
					.getRequestDispatcher("/09_upload/2_pds/invalid.jsp");
			dispatcher.forward(req, resp);
		}
	}
	...
	private PdsItem saveUploadFile(HttpServletRequest req) throws IOException,
		...
		String realPath = FileSaveHelper.save("D:\\MyClass\\JSP\\workspace\\First\\WebContent\\09_upload\\upload\\",
