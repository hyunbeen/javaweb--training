...
<div id="phonesaveform" data-role="page" data-theme="a">
	<script type="text/javascript">
		function phonesave() {
			...
			$.mobile.changePage("phonelist.jsp", { type: "post", data: $("form#phonesaveform").serialize(), changeHash: false });
		}
	...
	<div data-role="content">
		<form id="phonesaveform" name="register" method="post" action="phonelist.jsp">
			...
			<div data-role="fieldcontain">
				<fieldset data-role="controlgroup" data-type="horizontal">
					...
					<label for="radio1">흰색</label>
					<input id="radio2"  type="radio" name="pcolor" value="흰색"/>
					<label for="radio2">깜장</label>
				</fieldset>
			</div>
