...
<form id='frm' action='<%=pjName %>/Login?cmd=loginPwdFindAcc-page' method="post">
...
<input type="button" name="pwdBtn" id="pwdBtn" value=" 확 인   "
