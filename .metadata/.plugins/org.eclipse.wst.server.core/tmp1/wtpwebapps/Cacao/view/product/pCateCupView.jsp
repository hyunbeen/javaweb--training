...
<%
List<Info> catelist1 = (List<Info>)session.getAttribute("Cupresultall");
List<Info> catelist2 = (List<Info>)session.getAttribute("Cupresulthall");	
List<Info> catelist3 = (List<Info>)session.getAttribute("Cupresultlall");	
List<Info> catelist4 = (List<Info>)session.getAttribute("Cupresultsell");	
...
<select onchange="location.href='/Cacao/Product?cmd=pCateCupView-page&order='+this.value;" class="dropdown1" style="float:right">
